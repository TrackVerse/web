...
export const ImageZoom = ({
	...
	<div
		className={cn(
			...
			"**:data-rmiz-btn-zoom:m-0 **:data-rmiz-btn-zoom:size-10 **:data-rmiz-btn-zoom:touch-manipulation **:data-rmiz-btn-zoom:appearance-none **:data-rmiz-btn-zoom:rounded-[50%] **:data-rmiz-btn-zoom:border-none **:data-rmiz-btn-zoom:bg-transparent/70 **:data-rmiz-btn-zoom:p-2 **:data-rmiz-btn-zoom:outline-offset-2",
			"**:data-rmiz-btn-unzoom:m-0 **:data-rmiz-btn-unzoom:size-10 **:data-rmiz-btn-unzoom:touch-manipulation **:data-rmiz-btn-unzoom:appearance-none **:data-rmiz-btn-unzoom:rounded-[50%] **:data-rmiz-btn-unzoom:border-none **:data-rmiz-btn-unzoom:bg-transparent/70 **:data-rmiz-btn-unzoom:p-2 **:data-rmiz-btn-unzoom:outline-offset-2",
			...
			'[&_[data-rmiz-content="found"]_[data-zoom]]:cursor-zoom-in **:data-[rmiz-modal-overlay="visible"]:bg-transparent!',
			className,
		)}
	>
		<Zoom
